    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(limit_choices_to={'role': 'MANAGEMENT'}, on_delete=django.db.models.deletion.CASCADE, related_name='ManagementProfile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='RiderProfile',
            fields=[
                ...
                ('user', models.OneToOneField(limit_choices_to={'role': 'RIDER'}, on_delete=django.db.models.deletion.CASCADE, related_name='RiderProfile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('Type', models.TextField(blank=True, max_length=250, null=True)),
